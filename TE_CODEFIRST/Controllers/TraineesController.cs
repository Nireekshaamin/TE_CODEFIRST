...
namespace TE_CODEFIRST.Controllers
{
    public class TraineesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Tid,tfirstname,tlastname,email,TAge,DOB,gender")] Trainee trainee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Tid,tfirstname,tlastname,email,TAge,DOB,gender")] Trainee trainee)
        {
            if (id != trainee.Tid)
            {
                return NotFound();
        ...
        {
          return _context.Trainee.Any(e => e.Tid == id);
        }
    }
}
